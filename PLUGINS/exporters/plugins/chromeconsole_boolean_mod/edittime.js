...
{
	return {
		"name":			"Chrome Console",			// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"chromeconsole",			// this is used to identify this plugin and is saved to the project; never change it
		"version":		"0.1",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"Lets you log things to the Chrome console.",
		"author":		"Funstorm Ltd",
...
// Log View
AddAnyTypeParam("Data", "Can be an int or a string.")
AddAction(0, af_none, "Log Text", "Chrome Console", "Chrome Log {0}", "Log a number or string to the Chrome console.", "log");
AddObjectParam("Object", "Can be any object.")
AddAction(1, af_none, "Log Object", "Chrome Console", "Chrome Log {0}", "Log an object to the Chrome console.", "log");
AddObjectParam("Array", "Can be any array.")
AddAction(2, af_none, "Log Array", "Chrome Console", "Chrome Log Array {0}", "Log an array to the Chrome console.", "log_array");
