...
{
	return {
		"name":			"Windows 8",			// as appears in 'insert object' dialog, can be changed as long as "id" stays the same
		"id":			"win8",					// this is used to identify this plugin and is saved to the project; never change it
		"version":		"1.0",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"Access Windows 8 specific features like snap and roaming storage.",
		"author":		"Scirra.com",
...
AddCondition(0, cf_none, "Is Windows 8 app", "Windows 8", "Is Windows 8 app", "True if the game is currently running as a Windows 8 app.", "IsWindows8");
