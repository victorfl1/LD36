...
(function ()
{
	...
	instanceProto.getDebuggerValues = function (propsections)
	{
		...
		propsections.push({
			...
			"properties": [
				{"name": "IsActive", "value": this.m_TimeManagerList[i].IsActive, "readonly": true},
				{"name": "IsStopped", "value": this.m_TimeManagerList[i].IsStopped, "readonly": true},
				{"name": "CountDown", "value": this.m_TimeManagerList[i].CountDown, "readonly": true},
				{"name": "CountUp", "value": this.m_TimeManagerList[i].CountUp, "readonly": true},
				{"name": "ExtraStartTime", "value": this.m_TimeManagerList[i].TimeManagerExtraStartTime, "readonly": true},
				{"name": "MinuteBaseValue", "value": this.m_TimeManagerList[i].MinuteBaseValue, "readonly": true},
				{"name": "SecondBaseValue", "value": this.m_TimeManagerList[i].SecondBaseValue, "readonly": true},
				{"name": "MillisecondBaseValue", "value": this.m_TimeManagerList[i].MillisecondBaseValue, "readonly": true}
