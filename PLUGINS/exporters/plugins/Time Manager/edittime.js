/* ************************************************************************ 
	...
	Wishlist:
		- Add functionality to have division and multiplication with the Calculation function.
		- Fix possible issue with "Time counter with start value".
	
	v1.10
		- ADDED: 	Added the Construct save/load function to the Time Manager.
		- ADDED:	Added functionality for the Construct debugger. For the time being all information is set as readonly.
		- ADDED: 	Added the plugin into the Construct c2addon package for easier installation.
	v1.09
		- FUNCTION:	Added a calculation function to add and/or subtract a value from the counter. 
		- FIX:		Fixed where the TimeCountUpWithStartValue-function did not work properly. It should work as intended now.
		- FIX:		Fixed where MMSS (Minutes and seconds) and SSMM (Seconds and milliseconds) were mixed up, rendering the MMSS showing seconds and milliseconds and SSMM showing minutes and seconds.
	v1.08
...
function GetPluginSettings()
{
	return {
		...
		"version":		"1.10",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		...
		"help url":		"http://www.scirra.com/forum/plugin-time-manager_topic49030_post308144.html#308144",
...
AddStringParam("Label", "Enter label for this counter", ""); 
AddComboParamOption("Addition");
AddComboParamOption("Subtraction");
AddComboParam("Calculation", "Choose which calculation you want to use." , 0);
AddNumberParam("Value", "Enter value you want to calculate the time counter with (in milliseconds).", "1.0");
AddAction(16, af_none, "Calculate counter", "Time counter options", "{0} recalculates the time value using {1} and the value {2}", "Function that calculates a value with the given counter", "CalculateTimeValue");
